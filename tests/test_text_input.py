...
def test_text_input_page_title(page) -> None:
    ...
    expect(text_input_page.get_title()).to_have_text("Text Input")
...
def test_text_input(page) -> None:
    ...
    expect(text_input_page.get_button()).not_to_have_text(input_value)
    text_input_page.enter_text(input_value)
    text_input_page.click_button()
    expect(text_input_page.get_button()).to_have_text(input_value)